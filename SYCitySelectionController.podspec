...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    Quit create city selection contoller. Easy...
                   DESC

  s.homepage     = "https://github.com/KellenYangs/SYCitySelectionController"
  ...
  s.source       = { :git => "https://github.com/KellenYangs/SYCitySelectionController.git", :tag => s.version }
